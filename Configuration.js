...
function getEndpoints(deviceAddress, endpoints) {
    endpoints.addEndpoint("1", "Cumulative flow", endpointType.flowSensor);
    endpoints.addEndpoint("2", "Equipment status", endpointType.iasSensor);
    endpoints.addEndpoint("3", "Equipment Alarm", endpointType.iasSensor, iasEndpointSubType.alarmInput);
     endpoints.addEndpoint("4", "Temperature", endpointType.temperatureSensor);
   endpoints.addEndpoint("5", "Battery", endpointType.voltageSensor);
